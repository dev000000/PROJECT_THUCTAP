...
export default observer(function ReligionIndex() {
  ...
  const { religionList, pageSize, totalPages } = religionStore;
  useEffect(() => {
    religionStore.getAllReligionStore();
  }, []);
  const handleChangePageSize = (e) => {
    religionStore.setPaging({ pageSize: e.target.value });
  };
  const handleChangePageIndex = (e, value) => {
    religionStore.setPaging({ pageIndex: value });
  };
      ...
      <MaterialTable
        ...
        editable={{
          onRowAdd: async (newData) => {
            ...
            await religionStore.addReligionStore(newData);
            return Promise.resolve();
          },
          onRowUpdate: async (newData) => {
            await religionStore.updateReligionStore(newData);
          },
          onRowDelete: async (oldData) => {
            await religionStore.deleteReligionStore(oldData);
          },
        }}
        localization={{
          header: {
